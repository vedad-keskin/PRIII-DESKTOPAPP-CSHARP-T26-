    ...
    public partial class frmPretragaIB180079 : Form
    {
        ...
        private void UcitajStudentiKnjige()
        {
            ...
            var studentiKnjige = studentiKnjigeServis
                ...
                .Where(x => $"{x.Student.Ime} {x.Student.Prezime}".ToLower().Contains(naziv) ||
                x.Knjiga.Naziv.ToLower().Contains(naziv))
                .ToList();
        ...
        private void dgvStudentiKnjige_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 5)
            {
                ...
                var odabarnaStudentKnjiga = dgvStudentiKnjige.SelectedRows[0].DataBoundItem as StudentiKnjigeIB180079;

                odabarnaStudentKnjiga.DatumVracanja = DateTime.Now;
                odabarnaStudentKnjiga.Vracena = true;

                studentiKnjigeServis.Update(odabarnaStudentKnjiga);
